...
class MainMenuBar(QMenuBar):
    def __init__(self, parent=None) -> None:
        ...
        self.action_open = QAction("Open Journal", self)
        ...
        self.action_delete_today = QAction("Delete Today's Entries", self)
        ...
        self.menu_edit.addAction(self.action_delete_today)
